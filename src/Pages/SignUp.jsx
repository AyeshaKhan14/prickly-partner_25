      ...
      <Box m="200px">
        <Flex gap="150px">
          ...
          <form onSubmit={handleformsubmit}>
            ...
            <Text pb="40px" fontSize="sm" color="#978871" fontWeight="medium">
            ...
            <Text fontSize="13px" color="##e3c6b0">
            ...
            <Checkbox mt="35px" defaultChecked>
              Enable order updates and important information on Whatsapp
            </Checkbox>
            <Text fontSize="2xl" fontWeight="semibold" color="black" mt="35px">
              Verify
            </Text>
            <Text fontSize="13px" color="#e3c6b0">
        ...
        <Box textAlign="center" pt="50px">
          <Text fontSize="small" fontWeight="normal">
            ...
            <span style={{ color: "red" }}>Terms of service</span>
          </Text>
          <Text fontSize="small">
