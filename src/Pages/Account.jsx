        ...
        <Flex direction="row" justifyContent="space-between" w="90%" margin="auto">
            ...
            <Flex direction="column" w="40%">
                ...
                <div style={{display:"flex", gap:"30px",  color:"white"}}>
                    ...
                    <Box>
                        <Text>Rahul Nishad</Text>
                        <Text color="#66bbe0" fontWeight="600" fontStyle="italic">rahulnishad977@gmail.com</Text>
                        <Text color="#66bbe0" fontWeight="600">+91-8850902884</Text>
                    </Box>
                </div>
            ...
            <Box w="55%" p="3px 0px 5px 8px">
                ...
                <Flex direction="column">
                    <Flex gap="200px" my="3">
                        ...
                        <Heading size="sm" >Rahul Nishad</Heading>
                    </div>
                    <div>
                    ...
                    <Flex gap="90px">
                        ...
                        <Heading size="sm" >rahulnishad977@gmail.com</Heading>
                    </div>
                    <div>
                        <p style={{color:"gray"}}>Mobile Number</p>
                        <Heading size="sm" >+91 - 8850902884</Heading>
                    </div>
                    </Flex>
                </Flex>
            </Box>
